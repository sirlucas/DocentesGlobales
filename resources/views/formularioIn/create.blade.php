    ...
    {!! Form::open(['id' => 'form1','route' => 'formin.store', 'method' => 'post']) !!}
      <div class="box-header header-form with-border">
        ...
        proposito sea una <b>actividad Académica.</b></p>
          ...
          <div class=" pull-right">
            <ul id="wizard-steps" class="wizard-steps nav-wizard list-inline">
              <li class="step active">
                <a href="#formin_tab1" data-toggle="tab" class="btn btn-primary" aria-expanded="true">1</a>
              </li>
              <li class="step inline-item">
                <a href="#formin_tab2" data-toggle="tab" class="btn" aria-expanded="false">2</a>
              </li>
              <li class="step">
                <a href="#formin_tab3" data-toggle="tab" class="btn">3</a>
              </li>
              <li class="step">
                <a href="#formin_tab4" data-toggle="tab" class="btn">4</a>
              </li>
            </ul>
          </div>

          <div class="pull-left">
           <h5>Existing Relationships / (Relaciones Existentes) </h5>
        <!--
              <h5> Others / (Otros)</h5>
              <h5 id="title-tab"> Professor details / (Información del profesor)</h5>
             <h5>Hosting institution detail / (Detalles de la Institución)</h5> -->
          </div>
      ...
      <div class="box-body">
        ...
        @if ($errors->any())
          <div class="alert alert-danger">
            ...
            Hay algunos problemas con los datos ingresados. / (There were some problems with your input).<br>
            <ul>
        ...
        <div id="wizard-content" class="tab-content">
          ...
          <div id="formin_tab1" class="tab-pane ">
            <!-- panel izquierdo -->
            <div class="col-md-6">
              ...
              <div class="form-group col-sm-6">
                ...
                <input name=telefono class="form-control" data-inputmask="'mask': ['+99-999999999']" data-mask="" type="text">
              </div>
          ...
          <div id="formin_tab2" class="tab-pane active">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <textarea id="comentarios" class="form-control" rows="2" name="comentarios"></textarea>
              </div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group col-sm-6">
                ...
                <span class="fa fa-asterisk" style="font-size:8px;color:red"></span>
    						...
    						<div class="input-group date infecha">
    							...
    							<input id="datepicker_ida" type="text" class="form-control pull-right datepicker" required name="fechaida">
    						</div>
    					</div>
              ...
              <div class="form-group col-sm-6">
                ...
                <span class="fa fa-asterisk" style="font-size:8px;color:red"></span>
    						...
    						<div class="input-group date infecha">
    							...
    							<input id="datepicker_retorno" type="text" class="form-control pull-right datepicker" required name="fecharetorno">
    						</div>
    					</div>
              ...
              <div class="form-group">
                ...
                <select name="plantrabajo" class="form-control select2">
                  <option value="" disabled selected>Selecciona una opción...</option>
                  <option value="chocolate">Si</option>
                  <option value="vainilla">No</option>
                  <option value="cheesecake">Por Ingresar</option>
                </select>
              </div>
          ...
          <div id="formin_tab3" class="tab-pane">
            ...
            <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <input id="grupo" type="text" class="form-control" name="grupo"   placeholder="En proceso">
              </div>

              <div class="form-group">
                <label for="cargo_grupo" class="control-label">
                  Cargo
                  <br>
                  (Por favor, indique a las personas de la institución anfitriona con las que se reunirá durante su visita).
                </label>
                <input id="cargo_grupo" type="text" class="form-control" name="cargo_grupo"   placeholder="En proceso">
              </div>
          ...
          <!-- tab panel 3 -->
          <div id="formin_tab4" class="tab-pane">

            <!--panel izquierdo-->
            <div class="col-sm-6 pull-left">

              <div class="form-group">
                <label for="coalboracion" class="control-label">
        ...
        <!--    <div class="form-group">
              ...
              {!!Form::select('currency', $divisas->pluck('currency','idcurrency'), null,['placeholder'=>'Seleccione una divisa','class' => 'form-control select2' ,'required', 'id'=>'currency'])!!}
            </div> -->
      ...
      <div class="box-footer">
        <ul class="wizard clearfix">
          ...
          <li class="bs-wizard-prev pull-left disabled" style="display: none;"><button id="atras" class="btn btn-flat btn-default">Atrás</button></li>
          <li class="bs-wizard-next pull-right"><button id="sgte" class="btn btn-primary">Siguiente</button></li>
    <!--      <li class="bs-wizard-submit pull-right" ><button type="submit" class="btn btn-primary">Enviar</button></li> -->
        </ul>
      </div>
      <!-- /.box-footer -->
    {!! Form::close() !!}
